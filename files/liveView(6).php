...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=110394&cbuster=1649150440',
					origQString: 's=110394',
					placementId: 110394,
					x: 500,
					y: 350,
					videoType: 'flow',
